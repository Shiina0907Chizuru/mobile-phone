...
void LCD_DrawLine(u16 x1, u16 y1, u16 x2, u16 y2, u16 color)
{
    ...
    {
        LCD_DrawPoint1(uRow, uCol, color); 								//	画点
        xerr += delta_x ;
        yerr += delta_y ;
...
//函数返回：无
//**********************************************************************************************************/
void LCD_Draw_Circle1(u16 x0, u16 y0, u8 r, u16 color)
{
    int a, b;
    int di;
	...
	while(a <= b)
    {
        LCD_DrawPoint1(x0 + a, y0 - b, color);        					//	5
        LCD_DrawPoint1(x0 + b, y0 - a, color);        					//	0
        LCD_DrawPoint1(x0 + b, y0 + a, color);        					//	4
        LCD_DrawPoint1(x0 + a, y0 + b, color);        					//	6
        LCD_DrawPoint1(x0 - a, y0 + b, color);        					//	1
        LCD_DrawPoint1(x0 - b, y0 + a, color);
        LCD_DrawPoint1(x0 - a, y0 - b, color);        					//	2
        LCD_DrawPoint1(x0 - b, y0 - a, color);        					//	7
...
void LCD_ShowHzString(u16 x, u16 y, u8 *c, u16 PenColor, u16 BackColor)
{
	...
	for (i = 0; i < 16; i++)		 
	{
		...
		for (j = 0; j < 16; j++)
		{
			...
			{
				LCD_DrawPoint1(x + j, y + i, PenColor);                  //  字符颜色
			}
			else
			{
				LCD_DrawPoint1(x + j, y + i, BackColor);                 //  背景颜色
			}
		}
	}
